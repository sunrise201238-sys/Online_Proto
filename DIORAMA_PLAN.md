> Ported to the BA line from the demo line (2026-08-28): this record uses the demo build's weapon-name unit labels (PSG1 = Aru, Railgun = Kei, M4 = Saori, ...). Mechanics are identical on both lines.
