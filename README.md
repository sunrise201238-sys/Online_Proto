...
**Spawns (0.6.7):** Station spawns sit in the sheltered pockets along the platforms' outer back walls, between the ticket booths (±25, ±125 on the decks — the old track-corridor spawns anchored every fight to the railway axis), and Streets spawns moved from the road ends to the diagonal corners (±118, ±82). 2v2 teammates offset toward the map center on both. Streets' four corner smokestacks turn transparent while they block the camera, like the storefronts.
