...
- **Lock bracket bloom** (2026-09-21): the crosshair brackets around your target grow with your *own* current spread bloom on a universal scale — ×1 at the base cone, ×2.25 at the gun's own cap — so every weapon's bracket reads "how much of my bloom budget is spent", never the absolute cone size. The commander's lock-share triangles and the command-mode markers keep their size.
