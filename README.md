...
| Fubuki @56 · 30 rds | 35% (50→26) | 33% (45→27) | 28% (32→26) |
| Aris @56 · 8 rds | 71% (100→57) | 74% (93→67) | 56% (62→56) |
| Aru @120 · 5 rds | 100% (100→100) | 100% (100→100) | 89% (90→93) |
| Kei @120 · 5 rds | 100% (100→100) | 100% (100→100) | 100% (100→100) |

*Reading it:* the first→last gap is the bloom. The 900 RPM rifles open a magazine at 100% on a walking target and close it in the low 70s; Atsuko slips 100→90 even on a standing target: her capped cone's sure-hit line is 40 u, inside her 50 u lock, and a 30-round spray gets there by round 20; Koyuki's 100-round belt and Hina's 250 reach their capped cone inside the first third and sit there (~40% and ~34%), which is why their bots fire ungated. A flat pair means the gun never leaves its resting cone: the shotguns (7 blasts, a fixed pattern), and Hina and Koyuki from round ~40 on. The walk column is no longer one target speed for everyone — the 16 u/s SMG targets are harder than the 12 u/s rifle targets — so compare it as "each unit against her own peer". Sprint is no longer untouchable: crossing the line of fire at 24–28 u/s still gets clipped a quarter to a third of the time, and the rifles' sprint curve *rises* through the magazine (28→39) as the widening cone starts to cover the flight-time lead. The snipers are the flat lines at the top: Aru's 2,500 u/s bolt crosses 120 u in under 50 ms, so even a sprinter drifts about one unit before impact, and Kei's beam is instant.
