...
**Spawns:** Station spawns sit in the platforms' far corners (±128, ±112 on the decks — the old track-corridor spawns anchored every fight to the railway axis), and Streets spawns moved from the road ends to the diagonal corners (±118, ±82). Airport spawns sit on the ground directly in front of the corner ramps (±118, ±68 — ramp feet at |z| 50), close enough that every bot climbs to the security plateau within a couple of seconds and the fight happens up top. 2v2 teammates offset toward the map center on all three: a plain +Z offset would put one team's teammate nearer the objective than the other's, which on Airport handed the near team the climb race and left the far team fighting on the ground. Streets' four corner smokestacks turn transparent while they block the camera, like the storefronts.
